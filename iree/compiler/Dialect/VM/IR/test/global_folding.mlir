...
vm.module @global_i32_folds {
  // CHECK: vm.global.i32 mutable @g0 : i32 = 123 : i32
  ...
  vm.global.i32 mutable @g1 : i32 = 0 : i32
  // CHECK: vm.global.i32 @g2 : i32
  vm.global.i32 @g2 : i32 = 0 : i32
...
vm.module @global_load_i32_folds {
  ...
  vm.global.i32 mutable @g1 : i32 = 123 : i32
